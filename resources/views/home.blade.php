        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ url('contacts/create') }}" class='btn bg-success text-white mb-2'>@lang('contacts.register')</a>
                          ...
                          <tbody>
                            <tr>
                              <th scope="row">1</th>
                                ...
                                <td>
                                  <a href='{{ url('contacts/edit') }}' class='btn bg-primary text-white'>@lang('contacts.edit')</a>
                                </td>
                                <td>
