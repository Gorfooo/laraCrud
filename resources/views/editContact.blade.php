                            ...
                            <div class="row">
                                <div class="col-5">
                                    ...
                                    <div class='text-center'>
                                        <img src="{{asset('img/default_user.png')}}" class='rounded-circle' id='imgDisplay'
                                ...
                                <div class="col-7" style='height:10rem'>
                                    ...
                                    <textarea class="form-control" name="observation" maxlength="500" style='height:8rem'>{{$contact->observation}}</textarea>
